...
export const achievements = [
  {
    ...
    position: "4.0/4.0 CGPA 2 Times",
    content1: "Top Position in 2nd & 5th Semesters",
    content2: "Class Representative for Semester 2-8",
  ...
  },
  {
    ...
    position: "Gold Medalist & Cash Prize",
    content1: "Top Position in Full Stack Web Development",
    content2: "Gold Medalist in Full Stack Web Development",
    content3: "",
...
export const projects = [
  {
    id: "project-1",
    title: "GCUF SE Chatbot",
    github: "https://github.com/umairazmat/gcuf-se-chatbot",
    link: "https://github.com/umairazmat/gcuf-se-chatbot",
    image: comicify_ai,
    content:
  ...
  {
    id: "project-2",
    title: "Earth Green Pulse",
    github: "https://github.com/umairazmat/Earth-Green-Pulse",
    link: "https://earth-green-pulse.devlotech.com/",
    image: greentrust,
    content:
      "Developed a data visualization project showcasing CO₂ emissions using the OCO- 2 MIP Top - down CO₂ Budgets dataset (2015–2020). Created interactive maps and graphs with Python and Plotly to highlight emission trends and major contributors, hosted on a WordPress platform for accessibility and awareness.",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
  ...
  },
  {
    id: "project-3",
    title: "ChargeSwap",
    github: "https://github.com/umairazmat/IELTS-Bands-Master",
    link: "https://huggingface.co/spaces/umairazmat/IELTS-Bands-Master",
    image: chargeswap,
    content:
  ...
  },
  {
    id: "project-4",
    title: "ConfigPilot",
    github: "https://github.com/umairazmat/config-pilot",
    link: "",
    image: placeicon,
    content:
  ...
  {
    id: "project-7",
    title: "VR Gaming Coming Soon",
    github: "",
    link: "https://vrgaming.devlotech.com/",
    image: huntly,
    content:
  ...
  },
  {
    id: "project-10",
    title: "Portfolio",
    github: "https://github.com/umairazmat/personal-portfolio",
    link: "https://umairazmat.netlify.app/",
...
export const socialMedia = [
  {
    id: "social-media-1",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/umairazmat",
  },
  {
    id: "social-media-2",
    icon: AiFillGithub,
    link: "https://www.github.com/umairazmat",
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "mailto:umairazmatdev@gmail.com",
  },
  {
    id: "social-media-4",
    icon: SiLeetcode,
    link: "https://www.leetcode.com/umairazmatt",
  },
  {
    id: "social-media-5",
    icon: FaMedium,
    link: "https://medium.com/@umairazmatt",
  },
  {
    id: "social-media-6",
    icon: SiLinktree,
    link: "https://linktr.ee/umairazmat",
  },
];
...
export const aboutMe = {
  name: "Umair Azmat",
  githubUsername: 'umairazmat',
  tagLine: `
  Software Engineer | 
  MS & PhD Aspirant | 
  CGPA: 3.78/4.0 | 
  GenAI & MERN Enthusiast | 
  Former Trainer @SMIT (500+ students) | 
  Gold Medalist @PFTP | 
  DSA & LeetCode | 
  International Hackathon Participant | 
  IBM & Meta Certified Dev
`,
